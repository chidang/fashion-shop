...
if( !class_exists('Ftc_Blogs_Widget') ){
	class Ftc_Blogs_Widget extends WP_Widget {
		...
		?>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('orderby')); ?>"><?php esc_html_e('Order by', 'karo'); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('order')); ?>"><?php esc_html_e('Order', 'karo'); ?> </label>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_blog-image')); ?>"><?php esc_html_e('Show post blog-image', 'karo'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_title')); ?>"><?php esc_html_e('Show post title', 'karo'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>"><?php esc_html_e('Show post date', 'karo'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_author')); ?>"><?php esc_html_e('Show post author', 'karo'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_comment')); ?>"><?php esc_html_e('Show post comment', 'karo'); ?></label>
			</p>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_excerpt')); ?>"><?php esc_html_e('Show post excerpt', 'karo'); ?></label>
			</p>
			
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('excerpt_words')); ?>"><?php esc_html_e('Number of words in excerpt', 'karo'); ?> </label>
