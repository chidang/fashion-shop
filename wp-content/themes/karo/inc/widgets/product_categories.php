...
//							}
		...
		function form( $instance ) { 
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_post_count')); ?>"><?php esc_html_e('Show post count', 'karo'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_sub_cat')); ?>"><?php esc_html_e('Show sub categories', 'karo'); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('hide_empty')); ?>"><?php esc_html_e('Hide empty categories', 'karo'); ?></label>
			</p>
			<p>
