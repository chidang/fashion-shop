	...
	class Ftc_Recent_Comments_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			function form( $instance ) {
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>"><?php echo esc_html_e('Post type', 'karo'); ?> </label>
				...
				<p>
					<label for="<?php echo esc_attr($this->get_field_id('limit')); ?>"><?php esc_html_e('Number of comments to show', 'karo'); ?> </label>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_avatar')); ?>"><?php esc_html_e('Show avatar', 'karo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_date')); ?>"><?php esc_html_e('Show comment date', 'karo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_author')); ?>"><?php esc_html_e('Show comment author', 'karo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_comment')); ?>"><?php esc_html_e('Show comment content', 'karo'); ?></label>
				</p>
				...
				<p>
					...
					<label for="<?php echo esc_attr($this->get_field_id('show_post_on')); ?>"><?php esc_html_e('Show post on', 'karo'); ?></label>
				</p>
