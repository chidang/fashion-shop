...
if( !class_exists('Ftc_Feedburner_Subscription_Widget') ){
	class Ftc_Feedburner_Subscription_Widget extends WP_Widget {
		...
		?>
			<p>
                            <label for="<?php echo esc_attr($this->get_field_id('feedburner_id')); ?>"><?php esc_html_e('Enter your Feedburner ID', 'karo'); ?> </label>
			...
			<p>
                            <label for="<?php echo esc_attr($this->get_field_id('intro_text')); ?>"><?php esc_html_e('Enter your Intro Text Line 1', 'karo'); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('button_text')); ?>"><?php esc_html_e('Enter your button text', 'karo'); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('placeholder_text')); ?>"><?php esc_html_e('Placeholder text', 'karo'); ?> </label>
