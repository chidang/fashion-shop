...
if( !class_exists('Ftc_Blogs_Tabs_Widget') ){
	class Ftc_Blogs_Tabs_Widget extends WP_Widget {
		...
		?>
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('popular_title')); ?>"><?php esc_html_e('Popular tab title', 'karo'); ?> </label>
			...
			<p>
				<label for="<?php echo esc_attr($this->get_field_id('recent_title')); ?>"><?php esc_html_e('Recent tab title', 'karo'); ?> </label>
			...
			<p>
				...
				<label for="<?php echo esc_attr($this->get_field_id('show_thumbnail')); ?>"><?php esc_html_e('Show post thumbnail', 'karo'); ?></label>
			</p>
