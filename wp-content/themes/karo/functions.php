...
function ftc_setup() {
  ...
  add_theme_support( 'align-wide' );
    ...
    $ajax_nonce = wp_create_nonce("ftc-nonce");
...
wp_enqueue_script( 'sticky', get_template_directory_uri() . '/assets/js/jquery.sticky.js' , array(), null, true );
    ...
    wp_enqueue_script('ftc-global', get_theme_file_uri('/assets/js/custom.js'), array('jquery'), '1.0', true);
     wp_enqueue_script('quickshop1', get_theme_file_uri('/assets/js/quickshop.js'), array('jquery'), null, true);
...
if(isset($smof_data['cookies_policy_page'])){
            ...
            <div class="ftc-cookies-popup">
                <div class="ftc-cookies-inner">
                    <div class="cookies-info-text">
                        <?php 
                        if(isset($smof_data['cookies_text'])) {
                        echo do_shortcode( $smof_data['cookies_text'] );
                        } ?>
                    </div>
...
$domain = $ver->get('TextDomain');
    ...
    $plugins = array(
        ...
        ,array(
            ...
            'source'             => 'http://demo.themeftc.com/karo-woo/content/ftc-importer-karo'.'-'.$version .'.zip', // The plugin source.
            'required' => true, // If false, the plugin is only 'recommended' instead of required.
